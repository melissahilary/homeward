...
import { SignupButton } from "./SignupDrawer";
...
const FRAMES = [
  { frame: 1, eyebrow: null, headline: "Prescription stimulants can't be refilled.", sub: "So you run the whole process again, every thirty days. This is the month you already run." },
      ...
      <div className="mx-auto w-full max-w-content px-5 md:px-8">
        ...
        {isFinal && (
          <div className="mt-12 flex flex-wrap items-center gap-5">
            <SignupButton className="btn text-lg">Get started, $99 a year</SignupButton>
