...
export const ABOUT = {
  title: "About Daykeep",
  lede:
    "We are not going to tell you a diagnosis story. We do not have one, and borrowing one would be an insult to the people who do.",
  sections: [
    {
    ...
    },
    {
      ...
      body: "Not anyone seeking a diagnosis. Not anyone seeking a prescriber. Not anyone seeking medication without a script. If that is what you need, we are the wrong tool, and we would rather tell you now.",
    },
  ],
};
