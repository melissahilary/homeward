...
export const POSITIONING = {
  ...
  // The register is chief of staff, not wellness. Concierge operations.
  tagline: "We run the operational layer of your medication so you do not have to.",
};
...
// The five standards, stated as standards rather than denials. Second screen.
export const NEVER_DO = {
  title: "What we never do",
  items: [
    "We never touch your prescription.",
    "We take no money from pharmacies, PBMs, or manufacturers. Ever.",
    "We employ no clinicians and pay no referral fees.",
    "We bill no insurance.",
    "Nothing sends without your tap.",
  ],
};

// The comparison. Left is running it yourself, an afternoon on the phone,
// which is what 99% of visitors are actually weighing, not a named rival.
// Two rows are quantified; row three is the one a competitor cannot copy.
export const COMPARISON = {
  title: "The alternative is an afternoon of your life",
  columns: ["Running it yourself", "Daykeep"],
  note: "During the shortage, patients and prescribers report calling many pharmacies to find one fill; in one account, a psychiatrist's office called 20 for a single patient (NBC News, 2024). An ADDitude survey of about 11,000 people found 38% had trouble filling in the past year.",
  rows: [
    { label: "Pharmacies you call per cycle", self: "Often several", us: "0" },
    { label: "Days of warning before you run out", self: "0", us: "8" },
    {
      label: "You know which counters actually complete transfers",
      self: "No",
      us: "Yes, with the sample size shown",
    },
    {
      label: "Your legal rights get used",
      self: "No",
      us: "Sequential scripts, transfer, partial fill",
    },
    { label: "State rules verified before you ask", self: "No", us: "Yes" },
  ],
};
...
export const RIGHTS = {
  ...
  items: [
    {
      name: "90 days at once",
      cite: "21 CFR 1306.12(b)",
      body: "One visit can cover up to a 90-day supply as dated fills. Three trips to the office collapse into one.",
    },
    {
    ...
    },
    {
      ...
      body: "A partial fill is part of your quantity now and the rest within the window. Useful when a counter is short on stock.",
    },
  ],
};
  ...
  items: [
    {
      ...
      why: "It collapses three monthly runs into one and cuts your visits by two-thirds.",
    },
    {
    ...
    },
    {
      ...
      cite: "CARA §702 · 21 USC 829(f)",
      plain:
        "A partial fill is when a pharmacy gives you part of your quantity now and holds the rest for the allowed window. This matters when a counter has some of your quantity but not all of it.",
