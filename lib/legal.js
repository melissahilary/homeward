...
export const HEALTH_DATA = {
  ...
  sections: [
    {
      h: "What we collect",
      body: "The medication, strength, and formulation you track. Your last fill date and days supply. Your pharmacy and prescriber name as you type them. Your ZIP. Your email. That is the whole list. We do not collect your diagnosis, your medical records, or a login to any portal of yours.",
    },
    {
  ...
  sections: [
    {
      ...
      body: "Daykeep is a logistics and paperwork tool. It is not a clinical service. We do not diagnose, treat, or give medical advice. We do not prescribe, dispense, or supply medication. We do not send anything to a prescriber or pharmacy for you. Every message you send, you send yourself. Nothing here is a substitute for your prescriber or pharmacist.",
    },
    { h: "Who may use it", body: "Adults who already have a valid script and manage their own refills. Daykeep is not a way to obtain medication, a diagnosis, or a prescriber." },
