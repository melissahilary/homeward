...
export const HEALTH_DATA = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "If, and only if, you give a separate opt-in consent, we add your de-identified fill outcomes, which pharmacy, which manufacturer, filled or refused or out of stock, to the shared reliability map that helps other patients. Under that same opt-in, we may publish anonymized, aggregated statistics about medication access. This consent is its own checkbox, never bundled with anything else, and you can withdraw it any time. Identified health data is never part of the map or any published figure, and neither is ever sold.",
    },
    {
      h: "What we never do",
